...
\begin{itemize}
    ...
    \item \textbf{Drift constraints on multiple data items}: Are especially relevant for transactions which read multiple data items. Tolerates if possible 
...
Depending on the given system architecture, different replicaiton-strategies have been proposed on how updates are propagated towards outdated nodes.
...
point of view of real time applications. They ellaborated the concept of temporal validity with respect to value-based freshness,
