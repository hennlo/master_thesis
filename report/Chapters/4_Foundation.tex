...
\\
As illustrated by the authors of~\cite{}\todoMissing{cite} not solely the data replication will impact the trade-offs between latency and consistency \ref{sec:cap},
...
reads~\cite{}\todoMissing{cite}  since the transaction has not been committed yet and could still be rolled back.
