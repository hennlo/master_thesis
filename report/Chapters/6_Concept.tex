...
Consequently we will discuss the contents of Chapter~\ref{c:related} and propose solutions how these approaches and techniques can then be applied to Polystore systems.
...
we will define and conceptualize several possibilities in the subsequent sectionss, tailored to be solved by Polystore systems. 
