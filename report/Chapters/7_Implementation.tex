...
With the Lazy Replication and teh accompanied defferal of transactions in place, we already have a foundation to us ethese versions
for outdated data.
...
For every query the query tree is parsed and evaluated in terms of syntactical correctness. Additionally, the query is analyzed semantically where also the 
